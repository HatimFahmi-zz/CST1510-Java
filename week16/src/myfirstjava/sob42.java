...
public class sob42 extends Application {
	@Override 
	public void start(Stage primaryStage) {
		...
		rbRed.setOnAction(e -> {if (rbRed.isSelected()) {
		...
		rbYellow.setOnAction(e -> {if (rbYellow.isSelected()) {
				c1.setFill(Color.WHITE);
		...
		rbGreen.setOnAction(e -> {if (rbGreen.isSelected()) {
				c1.setFill(Color.WHITE);
				c2.setFill(Color.WHITE);
