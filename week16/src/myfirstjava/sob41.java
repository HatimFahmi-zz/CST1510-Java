...
public class sob41 extends Application {
...
public void start(Stage primaryStage) {
        ...
        tfDecimal.setOnKeyPressed(e -> {if (e.getCode() == KeyCode.ENTER) {
            try{  
            ...
            tfHex.setText("Wrong format");
            tfBinary.setText("Wrong format");
        }
        }
        });

        tfHex.setOnKeyPressed(e -> {if (e.getCode() == KeyCode.ENTER) {
        ...
        tfBinary.setOnKeyPressed(e -> {if (e.getCode() == KeyCode.ENTER) {
            try{    
            ...
            tfHex.setText("Wrong Format");
            tfDecimal.setText("Wrong Format");
